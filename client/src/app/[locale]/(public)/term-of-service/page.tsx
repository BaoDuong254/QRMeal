      ...
      <section className='py-12 md:py-20 lg:py-24'>
        <div className='max-w-4xl space-y-8'>
          <div>
            ...
            <p className='text-muted-foreground mt-4 leading-8'>{t("introductionContent")}</p>
          </div>
          <div className='space-y-4'>
            <h2 className='text-3xl font-bold'>{t("serviceUsage")}</h2>
            <p className='text-muted-foreground leading-8'>{t("serviceUsageContent")}</p>
          </div>
          <div className='space-y-4'>
            <h2 className='text-3xl font-bold'>{t("intellectualProperty")}</h2>
            <p className='text-muted-foreground leading-8'>{t("intellectualPropertyContent")}</p>
          </div>
          <div className='space-y-4'>
            <h2 className='text-3xl font-bold'>{t("termsChanges")}</h2>
            <p className='text-muted-foreground leading-8'>{t("termsChangesContent")}</p>
          </div>
          <div className='space-y-4'>
            <h2 className='text-3xl font-bold'>{t("contact")}</h2>
            <p className='text-muted-foreground leading-8'>{t("contactContent")}</p>
          </div>
        </div>
      </section>
    </div>
