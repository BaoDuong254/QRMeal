...
import { OrderTableContext } from "@/app/[locale]/manage/orders/OrderTable";
import OrderGuestDetail from "@/app/[locale]/manage/orders/OrderGuestDetail";
import { useTranslations } from "next-intl";

type OrderItem = GetOrdersResType["data"][0];

const useOrderTableColumns = (): ColumnDef<OrderItem>[] => {
  const t = useTranslations("OrderTableColumns");
